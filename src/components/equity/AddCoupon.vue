    ...
    <div class="addCoupon" >
      <div class="head clear">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item >新建优惠券规则</el-breadcrumb-item>
        </el-breadcrumb>
        <h1>
      ...
      <div class="form">
        ...
        >
          ...
          <div class="mb">
            ...
            <el-form-item label="是否退货返还" prop='type' v-if="form.type=='POINT_COUPON'">
            ...
            <!-- 是否补发 -->
            <el-form-item label="是否补发" prop="" class="" v-if="form.type=='BIRTHDAY_COUPON'" >
            ...
            <el-form-item label="优惠券发放" prop="day3" class="" v-if="form.type=='LEVEL_UP_COUPON'" >
                  升级后第 <el-input v-model="form.day3" class="date" maxlength='6'></el-input> 天 
            </el-form-item >
...
export default {
  ...
  created() {
    this.getLevelList(this.$route.params.id)
    this.getActList(this.$route.params.id)
    this.getList()
  },
  computed: {
    shopId(){
  ...
  methods:{
    ...
    getList(){
      this.$http({
        method:'get',
        url:''+process.env.API_ROOT+'/coupon/configs?pageIndex=1&pageSize=10&apiMerchantId=' + this.$route.params.id+'&couponType=BIRTHDAY_COUPON'
      }).then(res => {
    ...
    sub() {
      ...
      if(this.form.type=='POINT_COUPON'){
        data = {
          ...
          'couponConfigId':'',
          //商户ID
          'apiMerchantId':this.$route.params.id,
          //活动
