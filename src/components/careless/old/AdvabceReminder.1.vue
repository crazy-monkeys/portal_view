    ...
    <div class="addAct" v-if="!none && !rep && !look">    
       <div class="head clear">   
         <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>客户关怀</el-breadcrumb-item>
          <el-breadcrumb-item>预付款提醒</el-breadcrumb-item>  
          <el-breadcrumb-item v-if='!ruleForm.marketingPlanId'>新建预付款提醒</el-breadcrumb-item>      
          <el-breadcrumb-item v-if='ruleForm.marketingPlanId'>编辑预付款提醒</el-breadcrumb-item>      
        </el-breadcrumb>
        <h1 v-if='!ruleForm.marketingPlanId'> <i class="el-icon-back" @click="back(0)"></i>  <span >新建预付款提醒</span></h1>
        <h1 v-if='ruleForm.marketingPlanId'> <i class="el-icon-back" @click="back(1)"></i>  <span >编辑预付款提醒</span></h1>
      ...
      <div class="form">
        <el-form :model="ruleForm"  :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" label-position="top">
          ...
          <div class="condition">
            <h2>执行条件</h2>
            <p class="danger"> <i class="el-icon-warning" style="color: #3366FF"></i>  订单状态为“定金已付尾款未付”触发短信发送至收货人手机号</p>
            <el-form-item label="下单时间" prop="time3" >
              <el-date-picker
                prefix-icon='el-icon-date'
          ...
          <el-form-item class="sub">
            <el-button @click="submitForm('ruleForm',8,0)" >保存</el-button>
            <el-button type="primary" @click="submitForm('ruleForm',8,1)" >保存并启用</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
    ...
    <div class="look" v-if="look">    
      <div class="head clear">   
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>客户关怀</el-breadcrumb-item>
          <el-breadcrumb-item>预付款提醒</el-breadcrumb-item>  
          <el-breadcrumb-item>预付款提醒详情</el-breadcrumb-item>      
        </el-breadcrumb>
        <h1> <i class="el-icon-back" @click="back(3)"></i>  <span>预付款提醒详情</span>    </h1>
      ...
      <div class="box">
        ...
        <div class="condition">
          <h2>执行条件</h2>  
          <div ><span>下单时间</span> {{ruleForm.time3[0]}} 至 {{ruleForm.time3[1]}}</div>
