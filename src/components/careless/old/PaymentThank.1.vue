    ...
    <div v-if='none'>
      <div class="head clear">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>付款关怀</el-breadcrumb-item>      
        </el-breadcrumb>
        <h1>付款关怀</h1>
      ...
      <div class="box">
        <div class="btns clear">
          <!-- 新建按钮 -->
          <el-button @click="add" class="add" v-if='!ruleForm.marketingPlanId'>新建付款关怀</el-button>
          <el-button @click="add" class="add" v-if='ruleForm.marketingPlanId'>编辑付款关怀</el-button>
        </div>
        <div class="tab">
          <el-table
            :data="tableData"
    ...
    <div class="addAct" v-if="!none && !rep && !look">    
       <div class="head clear">  
         <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>客户关怀</el-breadcrumb-item>
          <el-breadcrumb-item>付款关怀</el-breadcrumb-item>  
          <el-breadcrumb-item v-if='!ruleForm.marketingPlanId'>新建付款关怀</el-breadcrumb-item>      
          <el-breadcrumb-item v-if='ruleForm.marketingPlanId'>编辑付款关怀</el-breadcrumb-item>      
        </el-breadcrumb> 
        <h1 v-if='!ruleForm.marketingPlanId'> <i class="el-icon-back" @click="back(0)"></i>  <span >新建付款关怀</span></h1>
        <h1 v-if='ruleForm.marketingPlanId'> <i class="el-icon-back" @click="back(1)"></i>  <span >编辑付款关怀</span></h1>
      ...
      <div class="form">
        <el-form :model="ruleForm"  :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" label-position="top">
          ...
          <div class="condition">
            <h2>执行条件</h2>
            <p class="danger"> <i class="el-icon-warning" style="color: #3366FF"></i>  当订单状态变更为“已付款”触发付款感谢提醒！短信将发送至收货人手机</p>
            ...
            <el-form-item label="收货地址" prop="raido1">
            ...
            <el-form-item label="已选择包含商品" prop="radio5" v-if='ruleForm.specifySkuCodes'>
              <el-radio-group v-model="ruleForm.radio5" >
                <el-radio :label="0">订单全部满足</el-radio>
                <el-radio :label="1">订单部分满足</el-radio>
              </el-radio-group>
            </el-form-item>
          </div>
          <div class="mb">
          ...
          <el-form-item class="sub">
            <el-button @click="submitForm('ruleForm',2,0)" >保存</el-button>
            <el-button type="primary" @click="submitForm('ruleForm',2,1)" >保存并启用</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
    ...
    <div class="look" v-if="look">    
      <div class="head clear">   
         <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>客户关怀</el-breadcrumb-item>
          <el-breadcrumb-item>付款关怀</el-breadcrumb-item>  
          <el-breadcrumb-item>付款关怀详情</el-breadcrumb-item>      
        </el-breadcrumb>
        <h1> <i class="el-icon-back" @click="back(3)"></i>  <span>付款关怀详情</span>    </h1>
  ...
  data () {
    return {
      ...
      rules: {
        ...
        radio5:[
          {required: true, message: "请选择订单满足条件", trigger: "change"}
        ],
        textarea: [
      ...
      this.$http.post(''+ process.env.API_ROOT + (this.ruleForm.marketingPlanId ? '/customer/care/config/edit' : '/customer/care/config/add'),
          {
            ...
            'skuRelative' : this.ruleForm.specifySkuCodes ?  this.ruleForm.radio5 : ''
          }
        ).then(res => {
            console.log("新增付款关怀", res);
                this.$message({
    ...
    getMore(marketingPlanId){
      this.$http({
        ...
        url:''+process.env.API_ROOT+'/customer/care/config/detail' + '?marketingPlanId=' + marketingPlanId,
          ...
          console.log("详情", res);
          if(res.data.code ==1){
            if(res.data.data.specify_sku_codes){
              
              this.ruleForm.radio5 = res.data.data.sku_relative
            }
