    ...
    <div v-if='none'>
      ...
      <div class="box">
        <div class="btns clear">
          <!-- 新建按钮 -->
          <el-button @click="add" class="add" v-if='!ruleForm.marketingPlanId'>新建商品回购提醒</el-button>
          <el-button @click="add" class="add" v-if='ruleForm.marketingPlanId'>编辑商品回购提醒</el-button>
        </div>
        <div class="tab">
          <el-table
            :data="tableData"
    ...
    <div class="addAct" v-if="!none && !rep && !look">    
       <div class="head clear">   
         <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>客户关怀</el-breadcrumb-item>
          <el-breadcrumb-item>商品回购提醒</el-breadcrumb-item>  
          <el-breadcrumb-item v-if='!ruleForm.marketingPlanId'>新建商品回购提醒</el-breadcrumb-item>      
          <el-breadcrumb-item v-if='ruleForm.marketingPlanId'>编辑商品回购提醒</el-breadcrumb-item>      
        </el-breadcrumb>
        <h1 v-if='!ruleForm.marketingPlanId'> <i class="el-icon-back" @click="back(0)"></i>  <span >新建商品回购提醒</span></h1>
        <h1 v-if='ruleForm.marketingPlanId'> <i class="el-icon-back" @click="back(1)"></i>  <span >编辑商品回购提醒</span></h1>
      ...
      <div class="form">
        <el-form :model="ruleForm"  :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm" label-position="top">
          ...
          <div class="condition">
            <h2>执行条件</h2>
            <p class="danger"> <i class="el-icon-warning" style="color: #3366FF"></i>  当订单状态变更为“交易已成功”触发商品回购提醒！短信将发送至收货人手机</p>
            <el-form-item label="付款后回购提醒间隔时间" prop="hours">
          ...
          <el-form-item class="sub">
            <el-button @click="submitForm('ruleForm',7,0)" >保存</el-button>
            <el-button type="primary" @click="submitForm('ruleForm',7,1)" >保存并启用</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
    ...
    <div class="look" v-if="look">    
      <div class="head clear">   
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>客户关怀</el-breadcrumb-item>
          <el-breadcrumb-item>商品回购提醒</el-breadcrumb-item>  
          <el-breadcrumb-item>商品回购提醒详情</el-breadcrumb-item>      
        </el-breadcrumb>
        <h1> <i class="el-icon-back" @click="back(3)"></i>  <span>商品回购提醒详情</span>    </h1>
      ...
      <div class="box">
        ...
        <div class="condition">
          ...
          <div ><span>付款后回购提醒间隔时间</span> {{ruleForm.day}}天{{ruleForm.hours}}小时</div>
      ...
      this.$http.post(''+ process.env.API_ROOT + (this.ruleForm.marketingPlanId ? '/customer/care/config/edit' : '/customer/care/config/add'),
          {
            ...
            'waitDay':this.ruleForm.day,
            'waitHour':this.ruleForm.hours
          }
        ).then(res => {
            console.log("新增商品回购提醒", res);
                this.$message({
