      ...
      <div class="box">
        <div class="tab">
          <el-table :data="tableData" style="width: 100%" height="700">
            ...
            <el-table-column type="index" width='100' label="代理商名称" :index='q'></el-table-column>
            ...
            <el-table-column prop="5" label="产品线" show-overflow-tooltip></el-table-column>
            <el-table-column prop="5" label="区域" show-overflow-tooltip></el-table-column>
            <el-table-column prop="5" label="授信额度" show-overflow-tooltip></el-table-column>
            <el-table-column prop="5" label="考核分数" show-overflow-tooltip></el-table-column>
            <el-table-column prop="5" label="引入时间" show-overflow-tooltip></el-table-column>
            <el-table-column prop="5" label="引入人" show-overflow-tooltip></el-table-column>
            <el-table-column prop="5" label="状态" show-overflow-tooltip></el-table-column>
