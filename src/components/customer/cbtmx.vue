      ...
      <div class="selBox">
        <el-form ref="form" disabled :model="form" label-position="top" class="form" :inline="true">
          ...
          <el-form-item label="发货方编码">
            <el-select v-model="value14" size="small" filterable placeholder="">
              <el-option
          ...
          <el-form-item label="申请时间" class="date">
            <el-date-picker size="small" v-model="value13" type="date" ></el-date-picker>
          </el-form-item>
          <el-form-item label="币种">
            <el-select v-model="value12" size="small" filterable placeholder="">
              <el-option
          ...
          <el-form-item label="外部客户名称">
            <el-select size="small"  v-model="value11" placeholder="">
          ...
          <el-form-item label="原因" class="txt">
            <el-input type="textarea" v-model="form.txt" :rows="2"  resize="none"></el-input>
          </el-form-item>
        ...
        <el-tabs v-model="activeName"  @tab-click="handleClick">
          <el-tab-pane label="单据信息" name='first'>
           ...
           <el-tab-pane label="附件" name="fourth">
            <div class="tabBox">
              <el-table :data="tableData5" border style="width: 100%" height="500">
                <el-table-column prop="t31" label="附件名" show-overflow-tooltip>
                </el-table-column>
