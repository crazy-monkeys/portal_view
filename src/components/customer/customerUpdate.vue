<template>
  ...
  <div class="customerUpdate">
    <div class="head clear">
            <el-page-header @back="back" content="客户信息修改"></el-page-header>
    </div>
    <div class="content">
      <div class="selBox">
               ...
               <el-table :data="form.addresses" style="width: 100%" height="300">
                ...
                <el-table-column prop="" label="" fixed="right" width="100">
                  <template slot="header">
                    <el-button type="primary" size="small" @click="addRow(10)">新增</el-button>
                  </template>
                  <template slot-scope='scope'>
            ...
            <div class="tabBox">
              <el-table :data="form.custStructure" style="width: 100%" height="300">
                ...
                <el-table-column prop="" label="股东性质" width="150">
                  <template slot-scope="scope">
                    <el-select size="small"   v-model="scope.row.strTwo">
                ...
                <el-table-column prop="" label="是否公司管理层" width="150">
                  <template slot-scope="scope">
                    <el-select size="small"   v-model="scope.row.strFour">
          ...
          <el-tab-pane label="附件" name="seventh">
            <div class="tabBox">
              <el-table :data="form.files" style="width: 100%" height="300" @row-click='rowClick'>
                ...
                <el-table-column  label="附件" width="300" show-overflow-tooltip>
                  <template slot-scope="scope" >
