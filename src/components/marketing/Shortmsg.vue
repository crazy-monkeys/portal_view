  ...
  <div class="shortMsg">
    ...
    <div class="box">
      <div class="btns clear">
        ...
        <!-- 日期选择 -->
        <el-date-picker v-model="value4" prefix-icon="el-icon-fire" @change="selTime" type="daterange" value-format="yyyy-MM-dd"
      ...
      <div class="tab">
        <el-table :data="tableData" style="width: 100%" height="700" @row-click="rowClick">
          ...
          <el-table-column prop="requestNum" label="发送人数" show-overflow-tooltip :render-header="renderHeader2"></el-table-column>
          ...
          <el-table-column label="操作" fixed="right">
            <template slot-scope="scope">
              <el-button @click.native.prevent="edit(scope.$index, tableData)" type="text" v-if="tableData[scope.$index].executeStatus == 0 || tableData[scope.$index].executeStatus == -1">编辑</el-button>
              <el-button @click.native.prevent="check(scope.$index, tableData)" type="text" v-if="tableData[scope.$index].executeStatus != 0 && tableData[scope.$index].executeStatus != -1">查看</el-button>
              <!-- <el-button
              ...
              <el-dropdown trigger="click" @command="b">
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item :command="{name:'启用',id:tableData[scope.$index].marketingActivityId,time:tableData[scope.$index].createTime}"
                    v-if="tableData[scope.$index].executeStatus == -1">启用</el-dropdown-item>
                  ...
                  <el-dropdown-item :command="{name:'短信内容',id:tableData[scope.$index].marketingActivityId,sms:tableData[scope.$index].marketingContent+ ' 退订回TD'}">短信内容</el-dropdown-item>
      ...
      <div class="block">
        <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage"
          :page-sizes="[10, 100]" :page-size="10" layout="sizes,total, jumper, prev, pager, next" :total="total"></el-pagination>
      </div>
    </div>
    <!-- 短信内容控件 -->
    <el-dialog title="短信内容" :visible.sync="smsdialogVisible" width="30%" :before-close="close" :close-on-click-modal="false">
      <p class="sms">{{sms}}</p>
