          ...
          <div class="drop">
            ...
            <el-dropdown trigger="click" @command='a'>
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item :command='{name:"条件1",value:"1"}'>条件1</el-dropdown-item>
                <el-dropdown-item :command='{name:"条件2",value:"2"}'>条件2</el-dropdown-item>
                <el-dropdown-item :command='{name:"条件3",value:"3"}'>条件3</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
