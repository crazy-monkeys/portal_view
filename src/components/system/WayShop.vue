<template>
  <div class="wayShop">
    ...
    <div class="box">
      ...
      <div class="tab">
        <el-table :data="tableData" style="width: 100%" height="700">
          ...
          <el-table-column prop="shopCode" label="shopCode" v-if="false">
          </el-table-column>

          <el-table-column prop="shopName" label="店铺名称" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="shopCode" label="店铺Id">
          </el-table-column>

          <el-table-column prop="shopManager" show-overflow-tooltip label="联系人姓名">
          </el-table-column>
          <el-table-column prop="contactMobile" show-overflow-tooltip label="联系人手机号码">
          </el-table-column>
          ...
          <el-table-column label="操作" width="100">
            <template slot-scope="scope">
              ...
              <el-button @click.native.prevent="edit(scope.$index, tableData)" type="text">
                编辑
              </el-button>
            </template>
          </el-table-column>
    ...
    <!-- 添加店铺控件 -->
    <el-dialog :title="!editToggle ? '新增店铺' : '编辑店铺'" top='8vh' :visible.sync="dialogVisible" width="30%" :before-close="close"
      ...
      <el-form :label-position="labelPosition" label-width="80px" :model="shopForm" :rules='rules' ref='shopForm' class="shopForm">
        ...
        <el-form-item label="门店所属渠道" v-if="sources.length!=0" prop='source'>
          <el-select v-model="shopForm.source" placeholder="请选择" class="selSource">
            <el-option v-for="item in sources" :key="item.marketingPlaceId" :label="item.marketingPlaceName" :value="item.marketingPlaceId"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="门店所属渠道" v-if="sources.length==0" prop='source'>
