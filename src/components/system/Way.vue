  ...
  <div class="way">
    ...
    <div class="box">
      <div class="btns">
        ...
        <el-date-picker size='small' v-model="time" prefix-icon="el-icon-fire" @change="selTime" type="datetimerange"
      ...
      <div class="tab">
        <el-table :data="tableData" style="width: 100%" height="700" @row-click='rowClick'>
          <el-table-column type="index" label="编号" :index='q' width="80">
          </el-table-column>
          <el-table-column prop="marketingPlaceId" label="marketingPlaceId" v-if="false">
          </el-table-column>

          <el-table-column prop="marketingPlaceName" label="渠道名称" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="marketingPlaceCode" label="渠道ID">
          </el-table-column>

          <el-table-column prop="marketingPlaceNumber" show-overflow-tooltip label="店铺数量">
          </el-table-column>
          <el-table-column prop="createTime" show-overflow-tooltip label="创建时间">
          </el-table-column>
          <el-table-column label="操作" width="auto">
            <template slot-scope="scope">
              <el-button @click.native.prevent="look(scope.$index, tableData)" type="text" :disabled="!tableData[scope.$index].marketingPlaceNumber ? true : false"
                :class='!tableData[scope.$index].marketingPlaceNumber ? "dis" : ""'>
                查看店铺列表
              </el-button>
              <el-button @click.native.prevent="rename(scope.$index, tableData)" type="text">
                重命名
              </el-button>
              <el-button @click.native.prevent="del(scope.$index, tableData)" type="text" :disabled="tableData[scope.$index].marketingPlaceNumber ? true : false"
                :class='tableData[scope.$index].marketingPlaceNumber ? "dis" : ""'>
                删除
              </el-button>
    ...
    <!-- 添加渠道控件 -->
    <el-dialog title="新增渠道" top='15vh' :visible.sync="dialogVisible" width="30%" :before-close="close"
    ...
    <!-- 重命名渠道 -->
    <el-dialog title="重命名渠道" top='15vh' :visible.sync="renameVis" width="30%" :before-close="close"
      :close-on-click-modal="false">
