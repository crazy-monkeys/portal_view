    ...
    <div class="sellBox">
      <div class="head clear">
        <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item>查询列表1</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      ...
      <div class="box">
        <div class="tab">
          <el-table :data="tableData" border style="width: 100%" height="100%" @row-click="rowClick">
            ...
            <el-table-column prop="monthly_init_total_qty" label="期初库存数量合计" show-overflow-tooltip width="150">
            </el-table-column>
            <el-table-column prop="monthly_init_total_amount" label="期初金额合计" show-overflow-tooltip width="150">
            </el-table-column>
            <el-table-column prop="monthly_end_total_qty" label="期末库存数量合计" show-overflow-tooltip width="150">
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="monthly_end_total_amount" label="期末金额合计" width="150">
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    async getList(){
      var data = this.form
      const res = await inventorySummary(data);
