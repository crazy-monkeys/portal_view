    ...
    <div>
      <div class="head clear">
        <el-breadcrumb separator="/">
          <el-breadcrumb-item to='/home/credit/list'>授信额度</el-breadcrumb-item>
          <el-breadcrumb-item>授信额度申请(代理商)</el-breadcrumb-item>
        </el-breadcrumb>
        <!-- <h1>客户查询</h1> -->
      </div>
      ...
      <div class="box">
         <div class="btns clear">
           <el-button size='small' class='add' type='primary' @click='create' >新建</el-button>
        </div>
        <div class="tab">
          <el-table :data="tableData" style="width: 100%" height="700">
            ...
            <el-table-column prop="2" label="原额度" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="3" label="申请额度" show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="4" show-overflow-tooltip label="提交时间">
            </el-table-column>
            <el-table-column prop="5" label="审批时间" show-overflow-tooltip>
            </el-table-column>
            <el-table-column show-overflow-tooltip prop="7" label="审批意见">
            </el-table-column>
