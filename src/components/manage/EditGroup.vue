      ...
      <el-form
        ...
        <div class="choose">
          ...
          <el-form-item label="分组名称：" prop='name' :rules='rules.name' label-position="top">
              <el-input v-model="baseForm.name" class="name" maxlength='10' ></el-input>
...
export default {
    ...
    deal:{
      handler:function(n,o){
       ...
       for ( var i in n ){
        ...
        for ( var i =0;i<this.rfm.length;i++ ){
            // console.log(i,n[i])
          if(this.rfm[i].value){
            this.toggle = false
        ...
        for ( var i =0;i<this.marketing.length;i++ ){
            // console.log(i,n[i])
          if(this.marketing[i].value){
            this.toggle = false
  ...
  methods: {
    ...
    edit(){
      ...
      this.$http
          .post("" + process.env.API_ROOT + "/customer/manage/customerGroup/edit", data)
          .then(res => {
            console.log(res);
            if (res.data.code == 1) {
             this.$message({
      ...
      this.$http({
        ...
        .then(res => {
          ...
          if (res.data.code == 1) {
            ...
            // this.radio = '';
            // this.id='';
            this.baseForm.name = res.data.data.customerGroupName
            this.baseForm.catalog = res.data.data.catalogId
              if(data[0]){
                //性别显示否
