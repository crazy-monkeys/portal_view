    ...
    <div >
      <div class="head clear">
        <el-breadcrumb separator="/" >
          <el-breadcrumb-item to='/home/sell'>菜单一</el-breadcrumb-item>
          <el-breadcrumb-item to='/home/sell/sellIndex'>菜单1-1</el-breadcrumb-item>      
        </el-breadcrumb>
        <h1>菜单1-1</h1>
      ...
      <div class="box">
        <div class="btns clear">
          ...
          <el-button class="sec" @click="search" size='small' type='primary' plain>搜索</el-button>
...
.sell{
  ...
  .head{
    h1{
        ...
        padding: 0 50/$sc+rem;
        span{
          border-left: 1/$sc+rem solid #ccc;
          padding: 0 20/$sc+rem
        }
        i{
          font-weight: bold;
    ...
    .btns{
        ...
        .drop{
          ...
          .el-dropdown{
            ...
            border-right: 1/$sc+rem solid #ccc;
            padding: 0  10/$sc+rem;
            span{
              font-size: 14/$sc+rem
            }
