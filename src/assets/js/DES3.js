 ...
 * DES �����㷨 
 * 
 * �ú�������һ�� 8 �ֽ��ַ�����Ϊ��ͨ DES �㷨����Կ��Ҳ���� 64 λ�������㷨ֻʹ�� 56 λ�������߽���һ�� 24 �ֽ��ַ�����Ϊ 3DES 
 * �㷨����Կ���ڶ���������Ҫ���ܻ���ܵ���Ϣ�ַ���������������ֵ��������˵����Ϣ�Ǽ��ܻ��ǽ��ܣ��������Ŀ�ѡ���� mode ����� 0 ��ʾ ECB 
 * ģʽ��1 ��ʾ CBC ģʽ��Ĭ���� ECB ģʽ�����һ����ѡ����һ�� 8 �ֽڵ����������ַ������� ECB ģʽ�²�ʹ�ã������ص��������ַ����� 
 * 
 * ������ <br> 
 * key: 8�ֽ��ַ�����Ϊ��ͨ DES �㷨����Կ,�� 24 �ֽ��ַ�����Ϊ 3DES <br> 
 * message�� ���ܻ���ܵ���Ϣ�ַ���<br> 
 * encrypt: ����ֵ��������˵����Ϣ�Ǽ��ܻ��ǽ���<br> 
 * mode: 1:CBCģʽ��0:ECBģʽ(Ĭ��)<br> 
 * iv:<br> 
 * padding: ��ѡ��, 8�ֽڵ����������ַ������� ECB ģʽ�²�ʹ�ã� 
 */
...
function des (key, message, encrypt, mode, iv, padding) {
    ...
    if(!encrypt ) { //����ǽ��ܵĻ������ܽ������PKCS7 padding���н��룬��ת����utf-8����
